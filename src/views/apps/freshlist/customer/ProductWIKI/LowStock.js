...
import { Low_Stock_Alerts } from "../../../../../ApiEndPoint/Api";
      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div>
                <Badge color="danger">{params.data?.Size} </Badge>
              </div>
            );
          },
        },
        {
          ...
          width: 200,
          cellRendererFramework: (params) => {
            return <div>{<span>{params.data?.MIN_stockalert}</span>}</div>;
          },
        },
      ],
      AllcolumnDefs: [],
