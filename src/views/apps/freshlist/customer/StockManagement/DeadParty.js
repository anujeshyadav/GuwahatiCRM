...
import { Dead_party_List } from "../../../../../ApiEndPoint/Api";
...
class StockTransfer extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="d-flex align-items-center cursor-pointer">
                <div className="">
                  <span>{params?.data?.Owner_Mobile_numer}</span>
                </div>
              </div>
            );
          },
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="d-flex align-items-center cursor-pointer">
                <div className="">
                  <span>{params?.data?.OwnerAddress}</span>
                </div>
              </div>
            );
          },
        ...
        {
          headerName: "dealing_Product_name",
          field: "dealing_Product_name",
          filter: "agSetColumnFilter",
          width: 180,
          cellRendererFramework: (params) => {
            return (
              <div className="d-flex align-items-center cursor-pointer">
                <div className="">
                  <span>{params?.data?.dealing_Product_name}</span>
                </div>
              </div>
            );
          },
        ...
        {
          headerName: "Annaul_turnover",
          field: "Annaul_turnover",
          filter: "agSetColumnFilter",
          width: 180,
          cellRendererFramework: (params) => {
            return (
              <div className="d-flex align-items-center cursor-pointer">
                <div className="">
                  <span>{params?.data?.Annaul_turnover}</span>
                </div>
              </div>
            );
          },
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="d-flex align-items-center cursor-pointer">
                <div className="">
                  <span>{params?.data?.CustomerTyoe}</span>
                </div>
              </div>
            );
          },
  ...
  async componentDidMount() {
    ...
    const InsidePermissions = CheckPermission("Dead Party");
    this.setState({ InsiderPermissions: InsidePermissions });
    let pageparmission = JSON.parse(localStorage.getItem("userData"));
    let userid = pageparmission?._id;
    let Url = `${Dead_party_List}/${userid}/${pageparmission?.database}`;
    await _GetList(Url)
      .then((res) => {
