...
import { Eye, ChevronDown, Edit, Delete, CornerDownLeft, Trash2 } from "react-feather";
...
import { Hrm_InterviewList, Hrm_InterDelete } from "../../../../../ApiEndPoint/Api";
...
class InterviewList extends React.Component {
                            ...
                            <div className="actions cursor-pointer">
                                        ...
                                        <Eye
                                            ...
                                            onClick={() =>
                                                this.props.history.push({
                                                    pathname: `/app/ajgroup/HRM/HrminterView/InterView/${params.data?._id}`,
                                                    state: params.data,
                                                })
                                            }
                                        />
                                ...
                                {this.state.InsiderPermissions.View && (
                                    <Edit
                                        ...
                                        onClick={() =>
                                            this.props.history.push({
                                                pathname: `/app/ajgroup/HRM/HrminterView/InterViewedit/${params.data?._id}`,
                                                state: params.data,
                                            })
                                        }
                                    />
                    ...
                    cellRendererFramework: (params) => {
                        return (
                            <div className="d-flex align-items-center cursor-pointer">
                                <div>
                                    <span>{params.data?.candidateName}</span>
                                </div>
                            </div>
                        );
                    },
                },
                {
                    ...
                    cellRendererFramework: (params) => {
                        return (
                            <div className="d-flex align-items-center cursor-pointer">
                                <div>
                                    <span>{params.data?.dateOfInterview}</span>
                                </div>
                            </div>
                        );
                    },
                ...
                },
                {
                    ...
                    cellRendererFramework: (params) => {
                        return (
                            <div className="d-flex align-items-center cursor-pointer">
                                <div>
                                    <Badge color="primary">{params.data?.status}</Badge>
                                </div>
                            </div>
                        );
                    },
    ...
    async Apicalling(id, db) {
        ...
        await _GetList(Hrm_InterviewList, id, db)
            .then((res) => {
                console.log(res);
                this.setState({ Loading: false });

                if (res?.Interview) {
                    this.setState({ rowData: res?.Interview });
                }
