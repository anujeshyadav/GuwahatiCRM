...
import { Hrm_JobList, Hrm_Delete } from "../../../../../ApiEndPoint/Api";
...
class JobList extends React.Component {
                ...
                },
                {
                    ...
                    cellRendererFramework: (params) => {
                        return (
                            <div className="d-flex align-items-center cursor-pointer">
                                <div>
                                    <span>{params.data?.numberOfPositions}</span>
                                </div>
                            </div>
                        );
                    },
                ...
                },
                {
                    ...
                    cellRendererFramework: (params) => {
                        return (
                            <div className="d-flex align-items-center cursor-pointer">
                                <div>
                                    <span>{params.data?.jobCategory}</span>
                                </div>
                            </div>
                        );
                    },
                },
                {
                    ...
                    cellRendererFramework: (params) => {
                        return (
                            <div className="d-flex align-items-center cursor-pointer">
                                <div>
                                    <Badge color="primary">{params.data?.skills}</Badge>
                                </div>
                            </div>
                        );
                    },
    ...
    async Apicalling(id, db) {
        ...
        await _GetList(Hrm_JobList, id, db)
            .then((res) => {
                this.setState({ Loading: false });

                if (res?.Job) {
                    this.setState({ rowData: res?.Job });
                }
    ...
    runthisfunction(id) {
        swal("Warning", "Sure You Want to Delete it", {
            ...
            switch (value) {
                case "delete":
                    _Delete(Hrm_Delete, id).then((res) => {
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() =>
                                                            history.push(
                                                                ...
                                                                "/app/ajgroup/HRM/RecPlace/jobForm"
                                                            )
                                                        }>
