...
import { Eye, ChevronDown, Delete, Edit, CornerDownLeft, Trash2 } from "react-feather";
...
import { Hrm_AppyList, Hrm_AppDelete } from "../../../../../ApiEndPoint/Api";
...
class JobappList extends React.Component {
              ...
              <div className="actions cursor-pointer">
                    ...
                    <Eye
                      ...
                      onClick={() =>
                        this.props.history.push({
                          pathname: `/app/ajgroup/HRM/HrmjpbApp/JobapView/${params.data?._id}`,
                          state: params.data,
                        })
                      }
                    />
                ...
                {this.state.InsiderPermissions.View && (
                  <Edit
                    ...
                    onClick={() =>
                      this.props.history.push({
                        pathname: `/app/ajgroup/HRM/HrmjpbApp/JobapeditList/${params.data?._id}`,
                        state: params.data,
                      })
                    }
                  />
        ...
        },
        {
          ...
          cellRendererFramework: (params) => {
            return (
              <div className="d-flex align-items-center cursor-pointer">
                <div>
                  <Badge color="primary">{params.data?.job}</Badge>
                </div>
              </div>
            );
          },
  ...
  async Apicalling(id, db) {
    ...
    await _GetList(Hrm_AppyList, id, db)
      .then((res) => {
        console.log(res);
