...
class CreateSalesManager extends React.Component {
                ...
                <>
                  <Col sm="12">
                    <Card>
                      <Row className="m-2">
                        <Col>
                          <h1 className="float-left">Sales Manager List</h1>
                        </Col>
                        <Col>
                          <span className="mx-1">
                            <FaFilter
                            ...
                            <Route
                              render={({ history }) => (
                                <Badge
                                  ...
                                  onClick={() =>
                                    history.push(
                                      "/app/SoftNumen/account/CreateSalesManag"
                                    )
                                  }
                                >
                                  <FaPlus size={15} /> Create Sales manager
                                </Badge>
                              )}
                            />
                          </span>
