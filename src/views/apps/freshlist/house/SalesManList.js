...
class CreateSalesMan extends React.Component {
                ...
                <>
                  <Col sm="12">
                    <Card>
                      <Row className="m-2">
                        <Col>
                          <h1 className="float-left">Sales Man List</h1>
                        </Col>
                        <Col>
                          <span className="mx-1">
                            <FaFilter
                            ...
                            <Route
                              render={({ history }) => (
                                <Badge
                                  ...
                                  onClick={() =>
                                    history.push(
                                      "/app/SoftNumen/account/CreateSalesTeam"
                                    )
                                  }
                                >
                                  <FaPlus size={15} /> Create Sales Man
                                </Badge>
                              )}
                            />
                          </span>
